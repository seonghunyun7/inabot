...
public:
    ...
    void initParameters();
private:
    rclcpp::Node::SharedPtr m_nh;     ///< Nodehandle for the driver node
    rclcpp::Node::SharedPtr m_pnh;    ///< Private Nodehandle for use with Serial Interface
    ...
    */
    static constexpr auto SET_STREAMING_SLOTS_ROS_IMU_RELATIVE  = ":80,0,38,41,43,255,255,255,255\n";  // 0 quaternion, 38 gyro rate, 41 linear accel, 43은 온도
    static constexpr auto SET_STREAMING_SLOTS_ROS_IMU_ABSOLUTE  = ":80,6,38,41,43,255,255,255,255\n";  // 6 untarted quaternion

     // 0 tared quaternion, 65 gyro rate, 41 linear accel
    static constexpr auto SET_STREAMING_SLOTS_QUATERNION_RAW_GYRO_RATE_ACCELERATION_LINEAR_IN_GLOBAL = ":80,0,65,41,43,255,255,255,255\n";
    ...
    //// Set axis directions
    static constexpr auto SET_AXIS_DIRECTIONS_X_Right_Y_Up_Z_Forward = ":116,0\n";
    static constexpr auto SET_AXIS_DIRECTIONS_X_Forward_Y_Right_Z_Up = ":116,3\n";
