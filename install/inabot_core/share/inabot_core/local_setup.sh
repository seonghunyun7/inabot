...
: ${AMENT_CURRENT_PREFIX:="/home/ysh/inabot_ws/install/inabot_core"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/inabot_core/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/inabot_core/environment/path.sh"
