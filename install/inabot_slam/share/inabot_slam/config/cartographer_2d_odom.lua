...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 90-- 60 -- 100

TRAJECTORY_BUILDER_2D.submaps.grid_options_2d.resolution = 0.01  -- 1cm 해상도
TRAJECTORY_BUILDER_2D.voxel_filter_size = 0.015  -- Voxel 크기를 약간 줄여서 처리 효율성 높임
...
TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.max_length = 0.1  -- 더 작은 범위로 필터링
TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.min_num_points = 150  -- 최소 포인트 수 설정
